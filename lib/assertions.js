...
},{"base64-js":2,"ieee754":37,"isarray":38}],4:[function(_dereq_,module,exports){
...
var _cancelOrder = _dereq_('../test/assertions/cancel-order');
...
},{"../test/assertions/active-page":42,"../test/assertions/auth-form":43,"../test/assertions/cancel-order":44,"../test/assertions/create-market-form":48,"../test/assertions/favorite-markets":49,"../test/assertions/filters":50,"../test/assertions/is-transactions-working":51,"../test/assertions/keywords":52,"../test/assertions/links":53,"../test/assertions/login-account":54,"../test/assertions/market":55,"../test/assertions/markets":58,"../test/assertions/markets-header":56,"../test/assertions/markets-totals":57,"../test/assertions/pagination":59,"../test/assertions/positions-markets":60,"../test/assertions/positions-summary":61,"../test/assertions/search-sort":62,"../test/assertions/selected-outcome":63,"../test/assertions/selected-user-open-orders-group":64,"../test/assertions/site-header":65,"../test/assertions/transactions":67,"../test/assertions/transactions-totals":66,"../test/assertions/url":68}],42:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],43:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],44:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (cancelOrder) {
	describe('augur-ui-react-components cancelOrder', function () {
		it('should exist', function () {
			_chai.assert.isFunction(cancelOrder, 'cancelOrder is not function.');
		});
	});
};
...
},{"chai":4}],45:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (endDate, refObj) {
	describe(refObj + '\'s endDate', function () {
		describe('value', function () {
			it('should exist', function () {
				_chai.assert.isDefined(endDate.value, 'endDate.value is not defined');
			});

			it('should be an instanceOf a Date', function () {
				_chai.assert.instanceOf(endDate.value, Date, 'endDate.value is not a date');
			});
		});

		describe('formatted', function () {
			it('should exist', function () {
				_chai.assert.isDefined(endDate.formatted, 'endDate.formatted is not defined');
			});

			it('should be a string', function () {
				_chai.assert.isString(endDate.formatted, 'endDate.formatted is not a string');
			});
		});

		describe('full', function () {
			it('should exist', function () {
				_chai.assert.isDefined(endDate.full, 'endDate.full is not defined');
			});

			it('should be a string', function () {
				_chai.assert.isString(endDate.full, 'endDate.full is not a string');
			});
		});
	});
};
...
},{"chai":4}],46:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (actual) {
	...
	describe(label, function () {
		...
		describe('roundedValue', function () {
			it('should exist', function () {
...
},{"chai":4}],47:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],48:[function(_dereq_,module,exports){
'use strict';
			...
			switch (createMarketForm.step) {
				...
				case 5:
					...
					describe('endDate', function () {
						...
						it('should have the correct shape', function () {
							(0, _endDate2.default)(createMarketForm.endDate, 'createMarketForm');
						});
					});
...
var _endDate = _dereq_('../../test/assertions/common/end-date');

var _endDate2 = _interopRequireDefault(_endDate);
...
},{"../../test/assertions/common/end-date":45,"../../test/assertions/common/formatted-number":46,"../../test/assertions/common/initial-fair-prices":47,"chai":4}],49:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],50:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],51:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],52:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],53:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (links) {
	...
	_chai.assert.isDefined(authLink, 'links.authLink isn\'t defined');
	_chai.assert.isObject(authLink, 'links.authLink isn\'t an object');
	_chai.assert.isDefined(authLink.href, 'links.authLink.href isn\'t defined');
	_chai.assert.isString(authLink.href, 'links.authLink.href isn\'t a string');
	_chai.assert.isDefined(authLink.onClick, 'links.authLink.onClick isn\'t defined');
	_chai.assert.isFunction(authLink.onClick, 'links.authLink.onClick isn\'t a function');

	var marketsLink = links.marketsLink;
	_chai.assert.isDefined(marketsLink, 'links.marketsLink isn\'t defined');
	_chai.assert.isObject(marketsLink, 'links.marketsLink isn\'t an object');
	_chai.assert.isDefined(marketsLink.href, 'links.marketsLink.href isn\'t defined');
	_chai.assert.isString(marketsLink.href, 'links.marketsLink.href isn\'t a string');
	_chai.assert.isDefined(marketsLink.onClick, 'links.marketsLink.onClick isn\'t defined');
	_chai.assert.isFunction(marketsLink.onClick, 'links.marketsLink.onClick isn\'t a function');

	var positionsLink = links.positionsLink;
	_chai.assert.isDefined(positionsLink, 'links.positionsLink isn\'t defined');
	_chai.assert.isObject(positionsLink, 'links.positionsLink isn\'t an object');
	_chai.assert.isDefined(positionsLink.href, 'links.positionsLink.href isn\'t defined');
	_chai.assert.isString(positionsLink.href, 'links.positionsLink.href isn\'t a string');
	_chai.assert.isDefined(positionsLink.onClick, 'links.positionsLink.onClick isn\'t defined');
	_chai.assert.isFunction(positionsLink.onClick, 'links.positionsLink.onClick isn\'t a function');

	var transactionsLink = links.transactionsLink;
	_chai.assert.isDefined(transactionsLink, 'links.transactionsLink isn\'t defined');
	_chai.assert.isObject(transactionsLink, 'links.transactionsLink isn\'t an object');
	_chai.assert.isDefined(transactionsLink.href, 'links.transactionsLink.href isn\'t defined');
	_chai.assert.isString(transactionsLink.href, 'links.transactionsLink.href isn\'t a string');
	_chai.assert.isDefined(transactionsLink.onClick, 'links.transactionsLink.onClick isn\'t defined');
	_chai.assert.isFunction(transactionsLink.onClick, 'links.transactionsLink.onClick isn\'t a function');

	var marketLink = links.marketLink;
	_chai.assert.isDefined(marketLink, 'links.marketLink isn\'t defined');
	_chai.assert.isObject(marketLink, 'links.marketLink isn\'t an object');
	_chai.assert.isDefined(marketLink.href, 'links.marketLink.href isn\'t defined');
	_chai.assert.isString(marketLink.href, 'links.marketLink.href isn\'t a string');
	_chai.assert.isDefined(marketLink.onClick, 'links.marketLink.onClick isn\'t defined');
	_chai.assert.isFunction(marketLink.onClick, 'links.marketLink.onClick isn\'t a function');

	var previousLink = links.previousLink;
	_chai.assert.isDefined(previousLink, 'links.previousLink isn\'t defined');
	_chai.assert.isObject(previousLink, 'links.previousLink isn\'t an object');
	_chai.assert.isDefined(previousLink.href, 'links.previousLink.href isn\'t defined');
	_chai.assert.isString(previousLink.href, 'links.previousLink.href isn\'t a string');
	_chai.assert.isDefined(previousLink.onClick, 'links.previousLink.onClick isn\'t defined');
	_chai.assert.isFunction(previousLink.onClick, 'links.previousLink.onClick isn\'t a function');

	var createMarketLink = links.createMarketLink;
	_chai.assert.isDefined(createMarketLink, 'links.createMarketLink isn\'t defined');
	_chai.assert.isObject(createMarketLink, 'links.createMarketLink isn\'t an object');
	_chai.assert.isDefined(createMarketLink.href, 'links.createMarketLink.href isn\'t defined');
	_chai.assert.isString(createMarketLink.href, 'links.createMarketLink.href isn\'t a string');
	_chai.assert.isDefined(createMarketLink.onClick, 'links.createMarketLink.onClick isn\'t defined');
	_chai.assert.isFunction(createMarketLink.onClick, 'links.createMarketLink.onClick isn\'t a function');
};
...
},{"chai":4}],54:[function(_dereq_,module,exports){
'use strict';
...
},{"../../test/assertions/common/formatted-number":46,"chai":4}],55:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (market) {
	...
	describe('augur-ui-react-components market state', function () {
		...
		it('market.endDate', function () {
			...
			(0, _endDate2.default)(market.endDate);
		});
		...
		it('market.takerFeePercent', function () {
			...
			(0, _formattedNumber2.default)(market.takerFeePercent);
		});

		it('market.makerFeePercent', function () {
			_chai.assert.isDefined(market.makerFeePercent);
			(0, _formattedNumber2.default)(market.makerFeePercent);
		});

		it('market.volume', function () {
			_chai.assert.isDefined(market.volume);
			(0, _formattedNumber2.default)(market.volume);
		});
		...
		it('market.outcomes', function () {
			...
			market.outcomes.forEach(function (outcome, i) {
				...
				it('market.outcomes[' + i + '].lastPricePercent', function () {
					...
					(0, _formattedNumber2.default)(outcome.lastPricePercent);
				});
				...
				userOpenOrders.forEach(function (openOrder, j) {
					...
					it('market.outcomes[' + i + '].userOpenOrders[' + j + '].avgPrice', function () {
						...
						(0, _formattedNumber2.default)(openOrder.avgPrice);
					});
					...
					it('market.outcomes[' + i + '].userOpenOrders[' + j + '].unmatchedShares', function () {
						...
						(0, _formattedNumber2.default)(openOrder.unmatchedShares);
					});

					it('market.outcomes[' + i + '].userOpenOrders[' + j + '].isCancelling', function () {
						_chai.assert.isDefined(openOrder.isCancelling);
						_chai.assert.isBoolean(openOrder.isCancelling);
					});

					it('market.outcomes[' + i + '].userOpenOrders[' + j + '].isCancelled', function () {
						_chai.assert.isDefined(openOrder.isCancelled);
						_chai.assert.isBoolean(openOrder.isCancelled);
					});
				});
			});
		});
		...
		it('market.tradeSummary.totalShares', function () {
			_chai.assert.isDefined(tradeSummary.totalShares);
			(0, _formattedNumber2.default)(tradeSummary.totalShares);
		});

		it('market.tradeSummary.totalCost', function () {
			_chai.assert.isDefined(tradeSummary.totalCost);
			(0, _formattedNumber2.default)(tradeSummary.totalCost);
		});

		it('market.tradeSummary.totalGas', function () {
			_chai.assert.isDefined(tradeSummary.totalGas);
			(0, _formattedNumber2.default)(tradeSummary.totalGas);
		});

		it('market.tradeSummary.totalFee', function () {
			_chai.assert.isDefined(tradeSummary.totalFee);
			(0, _formattedNumber2.default)(tradeSummary.totalFee);
		});
		...
		tradeOrders.map(function (trade, i) {
			it('market.tradeSummary.tradeOrders' + i + '.shares', function () {
				...
				(0, _formattedNumber2.default)(trade.shares);
			});
			...
			it('market.tradeSummary.tradeOrders' + i + '.ether', function () {
				...
				(0, _formattedNumber2.default)(trade.ether);
			});
			...
			it('market.tradeSummary.tradeOrders' + i + '.data.avgPrice', function () {
				...
				(0, _formattedNumber2.default)(trade.data.avgPrice);
			});
		});
		...
		it('market.userOpenOrdersSummary.openOrdersCount', function () {
			...
			(0, _formattedNumber2.default)(market.userOpenOrdersSummary.openOrdersCount);
		});

		var positionsSummary = market.positionsSummary;
		it('market.positionSummary', function () {
			_chai.assert.isDefined(positionsSummary);
			_chai.assert.isObject(positionsSummary);
		});

		it('market.positionSummary.numPositions', function () {
			_chai.assert.isDefined(positionsSummary.numPositions);
			(0, _formattedNumber2.default)(positionsSummary.numPositions);
		});

		it('market.positionSummary.qtyShares', function () {
			_chai.assert.isDefined(positionsSummary.qtyShares);
			(0, _formattedNumber2.default)(positionsSummary.qtyShares);
		});

		it('market.positionSummary.purchasePrice', function () {
			_chai.assert.isDefined(positionsSummary.purchasePrice);
			(0, _formattedNumber2.default)(positionsSummary.purchasePrice);
		});

		it('market.positionSummary.totalValue', function () {
			_chai.assert.isDefined(positionsSummary.totalValue);
			(0, _formattedNumber2.default)(positionsSummary.totalValue);
		});

		it('market.positionSummary.totalCost', function () {
			_chai.assert.isDefined(positionsSummary.totalCost);
			(0, _formattedNumber2.default)(positionsSummary.totalCost);
		});

		it('market.positionSummary.shareChange', function () {
			_chai.assert.isDefined(positionsSummary.shareChange);
			(0, _formattedNumber2.default)(positionsSummary.shareChange);
		});

		it('market.positionSummary.gainPercent', function () {
			_chai.assert.isDefined(positionsSummary.gainPercent);
			(0, _formattedNumber2.default)(positionsSummary.gainPercent);
		});

		it('market.positionSummary.netChange', function () {
			_chai.assert.isDefined(positionsSummary.netChange);
			(0, _formattedNumber2.default)(positionsSummary.netChange);
		});
...
},{"../../test/assertions/common/end-date":45,"../../test/assertions/common/formatted-number":46,"chai":4}],56:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],57:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],58:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],59:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],60:[function(_dereq_,module,exports){
'use strict';
...
function assertPositionMarket(positionMarket) {
	...
	positionMarket.outcomes.forEach(function (outcome) {
...
},{"../../test/assertions/common/formatted-number":46,"chai":4}],61:[function(_dereq_,module,exports){
'use strict';
...
},{"../../test/assertions/common/formatted-number":46,"chai":4}],62:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],63:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],64:[function(_dereq_,module,exports){
'use strict';
...
},{"chai":4}],65:[function(_dereq_,module,exports){
'use strict';
...
},{"./active-page":42,"./is-transactions-working":51,"./login-account":54,"./positions-summary":61,"./transactions-totals":66,"chai":4}],66:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (transactionsTotals) {
	_chai.assert.isDefined(transactionsTotals, 'transactionsTotals isn\'t defined');
	_chai.assert.isObject(transactionsTotals, 'transactionsTotals isn\'t an object as expected');
	_chai.assert.isDefined(transactionsTotals.title, 'transactionsTotals.title isn\'t defined');
	_chai.assert.isString(transactionsTotals.title, 'transactionsTotals.title isn\'t a string');
};

var _chai = _dereq_('chai');

},{"chai":4}],67:[function(_dereq_,module,exports){
'use strict';
...
exports.default = function (transactions) {
	...
	if (transactions[0] !== undefined) {
		_chai.assert.isDefined(transactions[0], 'transactions[0] isn\'t defined');
		_chai.assert.isObject(transactions[0], 'transactions[0] isn\'t an object');
...
function transactionAssertion(transaction) {
	_chai.assert.isDefined(transaction.id, 'transactions[0].id isn\'t defined');
	_chai.assert.isString(transaction.id, 'transactions[0].id isn\'t a string');
	_chai.assert.isDefined(transaction.type, 'transactions[0].type isn\'t defined');
	_chai.assert.isString(transaction.type, 'transactions[0].type isn\'t a string');
	_chai.assert.isDefined(transaction.status, 'transactions[0].status isn\'t defined');
	_chai.assert.isString(transaction.status, 'transcations[0].status isn\'t a string');
	_chai.assert.isDefined(transaction.message, 'transactions[0].message isn\'t defined');
	_chai.assert.isString(transaction.message, 'transactions[0].message isn\'t a string');
}

},{"chai":4}],68:[function(_dereq_,module,exports){
'use strict';
