...
exports.default = function (loginAccount) {
	...
	if (!loginAccount.id) return;

	describe('augur-ui-react-components loginAccount state', function () {
		it('loginAccount', function () {
		...
		it('loginAccount.linkText', function () {
		...
		it('loginAccount.secureLoginID', function () {
		...
		it('loginAccount.prettySecureLoginID', function () {
		...
		it('loginAccount.prettyAddress', function () {
		...
		it('loginAccount.localNode', function () {
		...
		it('loginAccount.editName', function () {
			_chai.assert.isDefined(loginAccount.editName, 'loginAccount.editName isn\'t defined');
			_chai.assert.isFunction(loginAccount.editName, 'loginAccount.editName isn\'t a function');
		});

		it('loginAccount.transferFunds', function () {
			_chai.assert.isDefined(loginAccount.transferFunds, 'loginAccount.transferFunds isn\'t defined');
			_chai.assert.isFunction(loginAccount.transferFunds, 'loginAccount.transferFunds isn\'t a function');
		});

		it('loginAccount.downloadAccountDataString', function () {
		...
		it('loginAccount.downloadAccountFileName', function () {
